...
<head>
    ...
    <title>Recuperar Contraseña — Importadora Anturios</title>
...
<div class="reset-card">
    <div class="reset-header">
        ...
        <p>Ingresa tu correo registrado y te enviaremos un enlace de recuperación.</p>
    </div>

    <div class="reset-body">
        @if (session('status'))
            <div class="alert alert-success d-flex align-items-center gap-2" style="font-size: 13px;" role="alert">
