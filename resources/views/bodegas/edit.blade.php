        ...
        <div class="col-md-10 py-3 px-4 bg-white">
            <div class="card shadow-sm border-0 rounded-4 mx-auto" style="max-width: 1200px;">
                <div class="card-header bg-info text-white rounded-top-4 text-center">
                    <h3 class="mb-0">
                        <i class="fas fa-edit me-2"></i> Editar Bodega
                    </h3>
                </div>
                <div class="card-body">
                    <!-- Mensajes de éxito -->
                    ...
                    <div class="card mb-4 border-0 bg-warning bg-opacity-10">
                        <div class="card-header bg-warning text-white rounded-top-4">
                            <h5 class="mb-0">
                                <i class="fas fa-edit me-2"></i> Modificar Información de la Bodega
                            </h5>
                        </div>
                        <div class="card-body">
                            <form method="POST" action="{{ route('bodegas.update', $bodega->idbodega) }}" role="form">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 mb-4">
                                        <label for="nombrebodega" class="form-label fw-bold">
                                        ...
                                        <input type="text" name="nombrebodega" id="nombrebodega"
                                            ...
                                            value="{{ $bodega->nombrebodega }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-12 col-md-6 mb-3">
                                        <button type="submit" class="btn btn-success fw-bold rounded-pill w-100">
                                            <i class="fas fa-save me-2"></i> Actualizar Bodega
                                        </button>
                                    </div>
                                    <div class="col-12 col-md-6 mb-3">
                                        <a href="{{ route('bodegas.index') }}" class="btn btn-info fw-bold rounded-pill w-100">
                    ...
                    <div class="card border-0 bg-light bg-opacity-50">
                        <div class="card-body text-center">
                            <div class="text-muted">
                                ...
                                <small>Editando bodega: <strong>{{ $bodega->nombrebodega }}</strong></small>
                            </div>
                        </div>
                    </div>
                </div>
