                        ...
                        <div class="col-12">
                            <div class="bg-light rounded-4 p-3">
                                <div class="d-flex align-items-center">
                                    <div class="bg-brand rounded-circle d-flex align-items-center justify-content-center me-3" style="width: 50px; height: 50px;">
                    ...
                    <form action="{{ route('empleados.update', $empleado->nro_identificacion) }}" method="POST" class="row g-3">
                        ...
                        <div class="col-md-6">
                            <label for="tipo_identificacion" class="form-label fw-bold">
                                <i class="fas fa-id-badge me-2 text-brand"></i> Tipo de Identificación
                            </label>
                        ...
                        <div class="col-md-6">
                            <label for="nro_identificacion" class="form-label fw-bold">
                                <i class="fas fa-id-card me-2 text-brand"></i> Nro. Identificación
                            </label>
                        ...
                        <div class="col-md-6">
                            <label for="nro_telefono" class="form-label fw-bold">
                                <i class="fas fa-phone me-2 text-brand"></i> Teléfono
                            </label>
