                ...
                <div class="card-body">
                    ...
                    <div class="card mb-4 border-0 bg-success bg-opacity-10">
                        <div class="card-header bg-success text-white rounded-top-4">
                            <h5 class="mb-0">
                                <i class="fas fa-shopping-bag me-2"></i> Productos Vendidos
                            </h5>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered align-middle">
                                    ...
                                    <tbody>
                                        @foreach($venta->detalles as $detalle)
                                            <tr>
                                                <td class="text-center fw-bold">{{ $detalle->producto->codigo ?? $detalle->producto_id }}</td>
                                                ...
                                                <td class="text-center fw-bold text-success">${{ number_format($detalle->precio_total, 2) }}</td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                </table>
                    ...
                    @if($venta->tipo_pago === 'Crédito')
                        ...
                        <div class="card mb-4 border-0 bg-warning bg-opacity-10">
                            <div class="card-header bg-warning text-white rounded-top-4">
                                <h5 class="mb-0">
                                    <i class="fas fa-money-bill-wave me-2"></i> Abonos Registrados
                                </h5>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered align-middle">
                                        ...
                                        <tbody>
                                            @forelse($abonos as $abono)
                                                <tr>
                                                    <td class="text-center fw-bold text-success">${{ number_format($abono->abono, 2) }}</td>
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-md-6 text-end">
                                            <span class="fs-4 fw-bold text-danger">
                                                ${{ number_format($venta->total_venta - $abonos->sum('abono'), 2) }}
                                            </span>
                                        </div>
                                    </div>
                                </div>
